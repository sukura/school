  ...
  <div class="classPage">
    ...
    <div class="table mt-2">
      ...
      <el-table :data="list" stripe @selection-change="handleSelectionChange">
        ...
        <el-table-column label="姓名" prop="className" align="center">
        ...
        <el-table-column label="学号" prop="classRoom" align="center" />
        <el-table-column label="日期" prop="time" align="center" />
        <el-table-column label="上课时间" prop="number" min-width="100" align="center" />
        <el-table-column label="班级" prop="leaveEarly" min-width="100" align="center" />
        <el-table-column label="课程" prop="lack" min-width="100" align="center" />
        <el-table-column label="任课老师" prop="late" min-width="100" align="center" />
        <el-table-column label="上课地点" prop="lateAndleave" min-width="100" align="center" />
        <el-table-column label="考勤状态" prop="attendance" width="200" align="center">
          <template slot-scope="scope">
            <div>
